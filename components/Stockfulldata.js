...
function Stockfulldata(props) {
  ...
  return (
    <>
    <div style={{width:`100vw`, height:`100vh`, position:'relative', zIndex:3, background:'white'}}>
      <button
        type="button"
        onClick={() => props.FullDetails(!props.stockfulldata)}
